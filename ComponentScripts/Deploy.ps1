...
if($envType -eq "prod"){
	$siteUri = "http://viewer-api.sarine.com/cache/v2/atom/sarine.viewer.color"
}
else{
	$siteUri = "http://viewer-api-$envId.$envType.sarine.com/cache/v2/atom/sarine.viewer.color"
}
